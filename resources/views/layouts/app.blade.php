                    ...
                    <div class="container">
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            ...
                            <ul class="navbar-nav me-auto">
                                ...
                                @endphp
                                <a href="{{ route('home') }}" class="navbar-brand mb-3 h1">
                                    <i class="bi-hexagon-fill me-2 text-white fs-1"></i> Data Master</a>
                                ...
                                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                    ...
                                    <ul class="navbar-nav flex-row flex-wrap">
                                        <li class="nav-item col-2 col-md-auto fs-4 "><a href="{{ route('home') }}"
                                                class="nav-link @if ($currentRouteName == 'home') active @endif">Home</a>
                                        </li>
                                        <li class="nav-item col-2 col-md-auto fs-4"><a href="{{ route('employees.index') }}"
